...
* Synthetic biology has traditionally focused on building nucleic acid-based circuits, thanks to the ease of programming DNA or RNA molecules. Now that we have proteins that behave in a similar way (Refs 2, 5, 10), wouldn't it be fun to build protein-based circuits? Here we demonstrate a way to create logic gates from scratch, using _de novo_ designed heterodimers. These building blocks offer not only programmability, but also robustness and transferability: they work as purified proteins, in cell-free extracts, yeasts, and T cells. [PDF](/files/2020science.pdf) [Physics Today](https://physicstoday.scitation.org/do/10.1063/PT.6.1.20200430a/full/), [Nature Methods](https://www.nature.com/articles/s41592-020-0865-1), [Genetic Engineering and Biotechnology News](https://www.genengnews.com/news/artificial-proteins-give-living-cells-a-computational-upgrade/)
